...
<nav class=" blue  darken-4" role="navigation">
   ...
   <div id="main-container" class="container z-depth-2">
      <div class="row">
    <div class="col s12">
    <h5 class="header grey-text ">Afficher la liste de téléphones par groupe</h5>
</div>
</div>
    <div class="row">
        <div class="col s12">
    <form>
        <div class="input-field">
          <input name="groupName" id="search" type="search" required>
          <label class="label-icon" for="search"><i class="material-icons">Nom du du groupe</i></label>
  ...
  <div class="section " id="index-banner">
   ...
   <ul>
        <%
        List<String> phones =  commonService.getPhoneNumbersByContactGroupName("M2miage");
